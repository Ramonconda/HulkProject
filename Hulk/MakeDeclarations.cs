namespace Hulk
{
    ...
    {
        public object Value { get => ValExpression?.GetValue(false); set { } }
        public Types Type { get; private set; }
        public HulkExpression ValExpression { get; private set; }
        ...
        public VariableDeclaration(List<string> names, string type, HulkExpression ValueExp)
        {
            ...
            if (!valueOk)
            {
                ...
                throw new SemanticError("Var declaration", type, received);
            }
            ValExpression = ValueExp;
        }
    ...
    { 
        ...
        public void CheckDefinition()
        {
            ...
            {
                throw new RegularError($"Function '{FunctionName}' may reach call stack limit (callstack limit is {HulkInfo.StackLimit})", "function");
            }
        }
        ...
        public void AddToHistory(HulkHistory Memoria)
        {
